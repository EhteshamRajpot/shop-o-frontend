...
interface AdminDashboardMainProps {
  getAllOrdersOfAdmin: any,
   getAllSellers: any
}
const AdminDashboardMain: React.FC<AdminDashboardMainProps> = ({ getAllOrdersOfAdmin, getAllSellers }) => {
  ...
  const adminEarning = adminOrders && adminOrders.reduce((acc: any, item: any) => acc + item.totalPrice * .10, 0);
